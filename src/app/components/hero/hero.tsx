    ...
    >
      <div className="flex flex-col gap-5 ">
        ...
        <div className="flex flex-col items-center justify-center gap-5 md:flex-row">
          <span className="text-center text-5xl font-semibold -tracking-wider text-secondary_300 drop-shadow-xl after:absolute after:left-0 after:top-2 after:-z-10 after:text-gray-700 after:opacity-60 after:blur-sm after:content-['REACT_DEVELOPER'] sm:text-6xl">
            REACT DEVELOPER
          </span>
